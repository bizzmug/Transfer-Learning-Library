...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    progress = ProgressMeter(
        ...
        [batch_time, data_time, losses, cls_accs, domain_accs, discre],
    ...
    for i in range(args.iters_per_epoch):
        ...
        # instantiate NWD
        discrepancy = NuclearWassersteinDiscrepancy(model.head).to(device)
        ...
        loss = cls_loss + transfer_loss * args.trade_off + 1. * discrepancy_loss
