...
def main(args: argparse.Namespace):
    ...
    optimizer_ad = SGD(classifier.get_parameters(),
    ...
    # start training
    # resume as want to continue training the latest net
    start_epoch = -1
    if args.resume:
    ...
    for epoch in range(start_epoch+1, args.epochs):
        ...
        # train for one epoch
        train(train_source_iter, train_target_iter, classifier, discrepancy, optimizer_ad, optimizer,
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          model: ImageClassifier, domain_discrepancy, optimizer_ad: SGD, optimizer,
    ...
    for i in range(args.iters_per_epoch):
        ...
        # discrepancy_loss.backward(retain_graph=True)
        # optimizer_ad.step()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', default=False, action='store_true',
                        help='whether train from lastest net')
    ...
    parser.add_argument('--rho', default=0.05, type=float,
                        metavar='RHO', help='not sure', dest='rho')
